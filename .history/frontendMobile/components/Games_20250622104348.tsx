      ...
      return (
        <SafeAreaView style={styles.gameContainer}>
          ...
          <ScrollView contentContainerStyle={styles.gameContentWrapper}>
            ...
            <Text style={styles.gameDetailText}>
              {membersWithPhotos} out of {totalMembers} members have submitted photos. we need {waitingFor} more photo<Text>{waitingFor !== 1 ? 's' : ''}</Text> before the comment game can begin.
            </Text>
          </ScrollView>
        </SafeAreaView>
      );
    ...
    return (
      <SafeAreaView style={styles.gameContainer}>
        ...
        >
          ...
          <Text style={styles.gamePromptText}>who in the group would be most likely to use this as a weapon?</Text>
